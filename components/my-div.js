    ...
    async displayDataInTable(data) {
        try {
            ...
            sortedData.forEach((user) => {
                ...
                numero_de_identificacionCell.textContent =
                    user.numero_de_identificacion || "";
                row.appendChild(numero_de_identificacionCell);

                const fecha_de_ingreso_al_programaCell = document.createElement("td");
                fecha_de_ingreso_al_programaCell.textContent =
                    user.fecha_de_ingreso_al_programa || "";
                ...
                id_skillCell.textContent =
                    user.evaluacion.skill.moduloSkill.nombre || "";
